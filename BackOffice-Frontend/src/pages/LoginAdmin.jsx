...
const LoginAdmin=()=>{
    ...
    function callWSLogin(){
        ...
        const url='https://webservice-backoffice-production.up.railway.app/admin';
        fetch(url, {       
            method:'POST',
                    ...
                    <div class="auth-inner my-2">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-2">Veuillez vous connectez pour accéder aux fonctionnalités d'administrateur</p>

                                    <div class="mb-1">
                                        <label for="login-email" class="form-label">Login</label>
                                        <input type="text" value="admin" ref={logins} class="form-control" id="login-email" name="login-email" aria-describedby="login-email" tabindex="1" autofocus=""/>
                                    </div>
                                    <div class="mb-1">
                                        <label for="login-email" class="form-label">Mot de Passe</label>
                                        <input type="password" value="admin" ref={mdp} class="form-control" id="login-password" />
                                    </div>
